...
cd $SCRATCH/results/Paper/noise_only
...
if __name__ == "__main__":
    ...
    simulation = input("Enter number of simulations: ")
    condition = input("Enter NO condition: ")
    
    for noise in [0,4,8]:
        for i in range(int(simulation)):
            slurm_script_path = create_slurm_script(noise, i, condition)
