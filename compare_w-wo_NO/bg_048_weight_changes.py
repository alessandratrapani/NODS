...
for i, noise_rate in enumerate(noise_rates):
    results_path = f"/media/amtra/Samsung_T5/RISULTATI_TESI/only_background/BG_{noise_rate}Hz.csv"
    results_path_NO = f"/media/amtra/Samsung_T5/RISULTATI_TESI/only_background/BG_{noise_rate}Hz_NO.csv"   
